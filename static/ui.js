...
function _providerSkipsModelMismatchWarning(providerId){
  ...
  // vertex routes google/ prefixed models — skip mismatch check entirely
  return !p||p==='custom'||p.startsWith('custom:')||p==='openrouter'||p==='vertex';
}
...
function getModelLabel(modelId){
  ...
  const STATIC_LABELS={'openai/gpt-5.4-mini':'GPT-5.4 Mini','openai/gpt-4o':'GPT-4o','openai/o3':'o3','openai/o4-mini':'o4-mini','anthropic/claude-sonnet-4.6':'Sonnet 4.6','anthropic/claude-sonnet-4-5':'Sonnet 4.5','anthropic/claude-haiku-3-5':'Haiku 3.5','google/gemini-3.5-flash':'Gemini 3.5 Flash','google/gemini-3.1-pro':'Gemini 3.1 Pro','google/gemini-3.1-flash':'Gemini 3.1 Flash','google/gemini-3.1-flash-lite':'Gemini 3.1 Flash Lite','google/gemini-3.1-pro-preview':'Gemini 3.1 Pro','google/gemini-3-flash-preview':'Gemini 3 Flash','google/gemini-3.1-flash-lite-preview':'Gemini 3.1 Flash Lite','google/gemini-2.5-pro':'Gemini 2.5 Pro','google/gemini-2.5-flash':'Gemini 2.5 Flash','deepseek/deepseek-v4-flash':'DeepSeek V4 Flash','deepseek/deepseek-v4-pro':'DeepSeek V4 Pro','deepseek/deepseek-chat-v3-0324':'DeepSeek V3 (legacy)','meta-llama/llama-4-scout':'Llama 4 Scout'};
